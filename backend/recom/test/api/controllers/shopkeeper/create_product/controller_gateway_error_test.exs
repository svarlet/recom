defmodule Recom.Api.Shopkeeper.CreateProduct.Controller_GatewayErrorTest do
  ...
  setup do
    ...
    expect(CreateProduct.Double, :create, fn ^product -> %GatewayError{} end)
    stub(Presenter.Stub, :present, fn _ -> "details about the gateway error" end)
  ...
  test "it delegates the creation of the response body to the presenter", context do
    assert context.response.resp_body == "details about the gateway error"
  end
end
