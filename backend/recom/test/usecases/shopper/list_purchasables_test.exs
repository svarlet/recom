defmodule Recom.Usecases.Shopper.ListPurchasablesTest do
  use ExUnit.Case, async: true
  use Timex

  import Mox
  import Recom.Usecases.Shopper.ListPurchasables

  alias Recom.Usecases.Shopper.PurchasablesGateway
